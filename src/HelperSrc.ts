...
export const NAME = Ce.checkVariable("MS_A_NAME") || (process.env.MS_A_NAME as string);
export const LABEL = Ce.checkVariable("MS_A_LABEL") || (process.env.MS_A_LABEL as string);
export const DEBUG = Ce.checkVariable("MS_A_DEBUG") || (process.env.MS_A_DEBUG as string);
export const NODE_ENV = Ce.checkVariable("MS_A_NODE_ENV") || (process.env.MS_A_NODE_ENV as string);
export const URL_ROOT = Ce.checkVariable("MS_A_URL_ROOT") || (process.env.MS_A_URL_ROOT as string);
export const URL_CORS_ORIGIN = Ce.checkVariable("MS_A_URL_CORS_ORIGIN") || (process.env.MS_A_URL_CORS_ORIGIN as string);
export const PATH_CERTIFICATE_KEY = Ce.checkVariable("MS_A_PATH_CERTIFICATE_KEY") || (process.env.MS_A_PATH_CERTIFICATE_KEY as string);
export const PATH_CERTIFICATE_CRT = Ce.checkVariable("MS_A_PATH_CERTIFICATE_CRT") || (process.env.MS_A_PATH_CERTIFICATE_CRT as string);
export const PATH_PUBLIC = Ce.checkVariable("MS_A_PATH_PUBLIC") || (process.env.MS_A_PATH_PUBLIC as string);
export const PATH_LOG = Ce.checkVariable("MS_A_PATH_LOG") || (process.env.MS_A_PATH_LOG as string);
export const PATH_FILE_INPUT = Ce.checkVariable("MS_A_PATH_FILE_INPUT") || (process.env.MS_A_PATH_FILE_INPUT as string);
export const PATH_FILE_SCRIPT = Ce.checkVariable("MS_A_PATH_FILE_SCRIPT") || (process.env.MS_A_PATH_FILE_SCRIPT as string);
