...
export const IS_DEBUG = Ce.checkVariable("MS_A_IS_DEBUG") || (process.env["MS_A_IS_DEBUG"] as string);
...
export const PATH_CERTIFICATE_PEM = Ce.checkVariable("MS_A_PATH_CERTIFICATE_PEM");
...
export const PERSISTENCE_SECOND = Ce.checkVariable("MS_A_PERSISTENCE_SECOND") || (process.env["MS_A_PERSISTENCE_SECOND"] as string);
