...
export const writeLog = (tag: string, value: string | Record<string, unknown> | Error): void => {
    if (process.env.MS_A_DEBUG === "true") {
        if (typeof process !== "undefined" && process.env.MS_A_PATH_LOG) {
            Fs.appendFile(`${process.env.MS_A_PATH_LOG}debug.log`, `${tag}: ${value.toString()}\n`, () => {
...
export const NODE_ENV = checkEnv("MS_A_NODE_ENV", process.env.MS_A_NODE_ENV);
export const URL_ROOT = checkEnv("MS_A_URL_ROOT", process.env.MS_A_URL_ROOT);
export const URL_CORS_ORIGIN = checkEnv("MS_A_URL_CORS_ORIGIN", process.env.MS_A_URL_CORS_ORIGIN);
export const PATH_CERTIFICATE_KEY = checkEnv("MS_A_PATH_CERTIFICATE_KEY", process.env.MS_A_PATH_CERTIFICATE_KEY);
export const PATH_CERTIFICATE_CRT = checkEnv("MS_A_PATH_CERTIFICATE_CRT", process.env.MS_A_PATH_CERTIFICATE_CRT);
export const PATH_PUBLIC = checkEnv("MS_A_PATH_PUBLIC", process.env.MS_A_PATH_PUBLIC);
...
export const PATH_FILE_SCRIPT = checkEnv("MS_A_PATH_FILE_SCRIPT", process.env.MS_A_PATH_FILE_SCRIPT);
